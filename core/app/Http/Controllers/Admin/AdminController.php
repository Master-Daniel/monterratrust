...
class AdminController extends Controller
{
    ...
    {
        // Generate 5-digit code (00000 to 99999)
        $code = str_pad(mt_rand(0, 99999), 5, '0', STR_PAD_LEFT);
        
        // File path - store in storage/app/codes (recommended)
        $filePath = storage_path('app/codes/cot_code.txt');
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'code'));
    }
