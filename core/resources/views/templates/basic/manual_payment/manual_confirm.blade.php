                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="alert alert-primary">
                                            <p class="mb-0"><i class="las la-info-circle"></i> @lang('You are requesting') <b>{{ showAmount($data['amount'], currencyFormat:false)  }} {{ $data['method_currency'] }}</b> @lang('to deposit.') </p>
                                        </div>
